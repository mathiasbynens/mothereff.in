(function(window, document) {
	...
	function update() {
		...
		if (regexES51ReservedWord.test(tmp) || !regexIdentifier.test(tmp)) {
			...
			input.className = es3warning || unicodeWarning ? 'warning' : '';
		}
