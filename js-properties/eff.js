(function(window, document) {
	...
	var input = document.getElementsByTagName('input')[0],
	    ...
	    regexIdentifierName = RegExp('^[' + identifierStart + '][' + identifierStart + identifierPartExclusive + ']*$'),
	...
	function update() {
		...
		dot.innerHTML = needsBrackets ? 'You can’t use dot notation here; you’ll have to use bracket notation:' : es3Warning ? 'For backwards compatibility with ES3, you can’t use dot notation here; you’ll have to use bracket notation:' : 'You can use dot notation here:';
