(function(window, document) {
	...
	function update() {
		...
		dot.innerHTML = needsBrackets ? 'You can’t use dot notation here; you’ll have to use bracket notation:' : 'You can use dot notation here:';
		pre2.className = needsBrackets ? 'warning' : '';
		text(mark1, needsQuotes ? quotedValue : value);
		text(mark2, needsBrackets ? '[' + quotedValue + ']' : '.' + value);
